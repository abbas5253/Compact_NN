...
def avg_pool(input_x,fil,strd,pad):
	return tf.nn.avg_pool(input_x,ksize=[1,fil[0],fil[1],1],strides = [1,strd[0],strd[1],1],padding=pad)
...
def normal_full_layer(input_layer,size_next,relu=True):
